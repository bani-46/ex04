...
extern int compound_statement(int break_label);
extern int statement(int break_label);
extern int condition_statement(int break_label);
extern int iteration_statement(int break_label);
extern int exit_statement(int break_label);
...
extern void asmprint_def_label(char *_name, char *_procname,int is_array);
